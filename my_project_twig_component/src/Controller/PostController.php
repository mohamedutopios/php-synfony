...
class PostController extends AbstractController
{
    ...
    public function __construct(PostManagerInterface $postManager, CategoryManagerInterface $categoryManager, private LoggerInterface $logger)
    {
    ...
    public function listFrame(): Response
    {
